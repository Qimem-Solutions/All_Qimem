    ...
    <div className="space-y-8">
      ...
      {columns === "basic" && !error ? (
        <p className="text-xs text-amber-200/80">
          Showing basic guest fields only. Run the latest Supabase migration for <code className="text-zinc-400">guests</code> to
          show age, party size, and payment on this list.
        </p>
      ) : null}
